    ...
    1: [function (require, module, exports) {
        ...
        DataProjector = (function (_super) {
            ...
            function DataProjector() {
                ...
                this.toolbar = new Toolbar("#toolbarData");
        ...
        Info = (function (_super) {
            ...
            Info.prototype.display = function (message) {
                return $("#messageData").append(message + "<br/>");
            };
        ...
        Projector = (function (_super) {
            ...
            Projector.prototype.addUIListeners = function () {
                ...
                $("#containerData").mousedown(this.onMouseDown);
                $("#containerData").mousemove(this.onMouseMove);
                return $("#containerData").mouseup(this.onMouseUp);
            };
        ...
        Storage = (function (_super) {
            ...
            //aqui es donde viene el archivo
            Storage.prototype.requestDatafile = function () {
                return this.onDatafile("/Scripts/data.json");
            };
